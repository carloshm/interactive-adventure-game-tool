...
this.save = function (e) {
  ...
  _this.scene.isEndScene = $advanced.$inputIsEndSceneTrue.checked;
  _this.scene.readPreviousOptions = $advanced.$inputReadPreviousOptionsTrue.checked;
  _this.scene.defaultOption = $advanced.$inputDefaultOptionSelect.value;
  console.log("set detault option to", _this.scene.defaultOption);

  _this.scene.voice = {
    intro: _this.$intro.value.trim(),
    prompt: _this.$voicePrompt.value.trim(),
    reentry: _this.$voiceReentry.value.trim(),
    outro: _this.$voiceExit.value.trim()
  };
