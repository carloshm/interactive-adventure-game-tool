...
This version is an extension to the BBC fork that added functionality to link between scenes. That fork has been extended to add re-enty text when you return to a scene, and outro text when you leave a scene. It also deduplicates utterances, which is important when you want to publish a skill.
